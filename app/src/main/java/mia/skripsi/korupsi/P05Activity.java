...
//
//public class P05Activity extends AppCompatActivity {
//
...
//            "3. Apakah perbuatan tersebut perbuatan curang yang dapat membahayakan keamanan orang atau barang, atau keselamatan negara dalam keadaan perang ?",
...
//
//        pertanyaan_perkara = (TextView) findViewById(R.id.textView12);
//        rg = (RadioGroup) findViewById(R.id.radioGroup5);
//        PilihanA = (RadioButton) findViewById(R.id.radioButton9);
//        PilihanB = (RadioButton) findViewById(R.id.radioButton10);
//
...
//            } else {
//                hasil = benar;
//                Intent selesai = new Intent(getApplicationContext(), hasil05Activity.class);
